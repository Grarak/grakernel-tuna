...
#define OMAP4460_VDD_MPU_OPP50_UV		898000
#define OMAP4460_VDD_MPU_OPP75_UV		923000
#define OMAP4460_VDD_MPU_OPP100_UV		1083000
#define OMAP4460_VDD_MPU_OPPTURBO_UV		1117000
...
static struct omap_vdd_dep_volt omap446x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPP_1_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPP_2_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
};
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 350000000, OMAP4460_VDD_MPU_OPP50_UV),
        /* MPU OPP1 - OPP75 */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 460000000, OMAP4460_VDD_MPU_OPP75_UV),
	/* MPU OPP2 - OPP100 */
